...
{                 
		DS18B20_Set_IO_Output(); 	//SET PG11 OUTPUT
    DS18B20_DQ_WRITE(0); 	//拉低DQ
    HAL_Delay_us(750);    	//拉低750us
    DS18B20_DQ_WRITE(1); 	//DQ=1 
...
{   
	uint8_t retry=0;
	DS18B20_Set_IO_Input();	//SET PG11 INPUT	 
